"""Native cognis-connect emit for apkpeek — forward findings to any platform.

Maps apkpeek's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    apkpeek ... --format json | apkpeek-emit --to stix
    apkpeek-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
