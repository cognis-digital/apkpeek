#!/usr/bin/env sh
# Universal installer for apkpeek. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/apkpeek.git"
echo "Installing apkpeek ..."
